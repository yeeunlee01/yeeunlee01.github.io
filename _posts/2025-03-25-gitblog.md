...
기존 글에서 추가적으로 오류를 해결했던 내용을 포함해 2025년 3월 현재 테마 v7.2.4 기준 Github 블로그를 만드는 과정에 대해 정리해보았습니다. 
...
심플한 UI로 기술 블로그에 널리 사용되고 있는 테마인 [Chirpy](https://github.com/cotes2020/jekyll-theme-chirpy) 를 사용해 블로그를 만들었습니다. [Chripy Starter](https://github.com/cotes2020/chirpy-starter)라는 바로 블로깅을 시작할 수 있는 간편 버전도 있지만, 이 포스트에서는 커스터마이징이 가능한 오리지널 버전을 Fork해서 사용합니다.
